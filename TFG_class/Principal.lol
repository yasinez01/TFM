\contentsline {lstlisting}{\numberline {4.1}{\ignorespaces Controlador del proyecto WebUI con métodos de selección de formaciones almacenados en base de datos.}}{12}{lstlisting.4.1}%
\contentsline {lstlisting}{\numberline {4.2}{\ignorespaces Interfaz de formaciones con métodos para llevar a cabo las operaciones sobre la base de datos.}}{14}{lstlisting.4.2}%
