...
\subsection{Lenguaje de programación y ecosistema .NET}
...
Un \textit{framework} puede entenderse como un conjunto de herramientas, componentes y
...
\subsection{Gestión de datos: Entity Framework y SQL Server}
...
Como motor de almacenamiento se ha utilizado \textbf{SQL Server}, una tecnología ampliamente extendida en entornos corporativos y que presenta ventajas significativas:
...
\subsection{Sistema de notificaciones y comunicaciones}
...
%Aunque el despliegue final se orienta al entorno corporativo, la solución ha sido diseñada
%para ser compatible tanto con entornos clásicos como con infraestructuras más modernas
%basadas en contenedores. Esto permite:

%\begin{itemize}
%	\item \textbf{Facilitar futuras migraciones} hacia entornos en la nube o infraestructuras
%	híbridas.
%	\item \textbf{Aumentar la portabilidad} del sistema sin requerir cambios en la lógica interna.
%	\item \textbf{Simplificar el mantenimiento}, al emplear tecnologías estandarizadas y de fácil supervisión para equipos técnicos.
%\end{itemize}
